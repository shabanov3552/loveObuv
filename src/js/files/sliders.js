...
import { Navigation, Thumbs, Pagination, Autoplay, Lazy } from 'swiper/modules';
/*
...
function initSliders() {
	...
	if (document.querySelector('.s')) { // Указываем скласс нужного слайдера
		// Создаем слайдер
		new Swiper('.s', { // Указываем скласс нужного слайдера
